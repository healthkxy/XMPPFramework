...
extern NSString *const XMPPBoshStreamErrorDomain;

enum XMPPBoshStreamErrorCode
{
	XMPPBoshStreamInvalidType,       // Attempting to access P2P methods in a non-P2P stream, or vice-versa
	XMPPBoshStreamInvalidState,      // Invalid state for requested action, such as connect when already connected
	XMPPBoshStreamInvalidProperty,   // Missing a required property, such as hostName or myJID
	XMPPBoshStreamInvalidParameter,  // Invalid parameter, such as a nil JID
	XMPPBoshStreamUnsupportedAction, // The server doesn't support the requested action
};
typedef enum XMPPBoshStreamErrorCode XMPPBoshStreamErrorCode;


@interface XMPPBoshStream : NSObject <XMPPTransportDelegate>
{
...
@protocol XMPPBoshStreamDelegate
@optional
 ...
 **/
- (void)xmppBoshStreamWillConnect:(XMPPBoshStream *)sender;
...
**/
- (void)xmppBoshStream:(XMPPBoshStream *)sender socketWillConnect:(AsyncSocket *)socket;
...
**/
- (void)xmppBoshStreamDidStartNegotiation:(XMPPBoshStream *)sender;
...
**/
- (void)xmppBoshStream:(XMPPBoshStream *)sender willSecureWithSettings:(NSMutableDictionary *)settings;
...
**/
- (void)xmppBoshStreamDidSecure:(XMPPBoshStream *)sender;
...
**/
- (void)xmppBoshStreamDidConnect:(XMPPBoshStream *)sender;
...
**/
- (void)xmppBoshStreamDidRegister:(XMPPBoshStream *)sender;

/**
 * This method is called if registration fails.
**/
- (void)xmppBoshStream:(XMPPBoshStream *)sender didNotRegister:(NSXMLElement *)error;

/**
 * This method is called after authentication has successfully finished.
 * If authentication fails for some reason, the xmppStream:didNotAuthenticate: method will be called instead.
**/
- (void)xmppBoshStreamDidAuthenticate:(XMPPBoshStream *)sender;

/**
 * This method is called if authentication fails.
**/
- (void)xmppBoshStream:(XMPPBoshStream *)sender didNotAuthenticate:(NSXMLElement *)error;
...
**/
- (BOOL)xmppBoshStream:(XMPPBoshStream *)sender didReceiveIQ:(XMPPIQ *)iq;
- (void)xmppBoshStream:(XMPPBoshStream *)sender didReceiveMessage:(XMPPMessage *)message;
- (void)xmppBoshStream:(XMPPBoshStream *)sender didReceivePresence:(XMPPPresence *)presence;
...
**/
- (void)xmppBoshStream:(XMPPBoshStream *)sender didReceiveError:(id)error;
...
**/
- (void)xmppBoshStream:(XMPPBoshStream *)sender willSendIQ:(XMPPIQ *)iq;
- (void)xmppBoshStream:(XMPPBoshStream *)sender willSendMessage:(XMPPMessage *)message;
- (void)xmppBoshStream:(XMPPBoshStream *)sender willSendPresence:(XMPPPresence *)presence;
...
**/
- (void)xmppBoshStream:(XMPPBoshStream *)sender didSendIQ:(XMPPIQ *)iq;
- (void)xmppBoshStream:(XMPPBoshStream *)sender didSendMessage:(XMPPMessage *)message;
- (void)xmppBoshStream:(XMPPBoshStream *)sender didSendPresence:(XMPPPresence *)presence;

/**
 * This method is called for every sendElement:andNotifyMe: method.
**/
- (void)xmppBoshStream:(XMPPBoshStream *)sender didSendElementWithTag:(UInt16)tag;
...
**/
- (void)xmppBoshStreamWasToldToDisconnect:(XMPPBoshStream *)sender;

/**
 * This method is called after the stream is closed.
**/
- (void)xmppBoshStreamDidDisconnect:(XMPPBoshStream *)sender;
...
**/
- (void)xmppBoshStream:(XMPPBoshStream *)sender didReceiveP2PFeatures:(NSXMLElement *)streamFeatures;
...
**/
- (void)xmppBoshStream:(XMPPBoshStream *)sender willSendP2PFeatures:(NSXMLElement *)streamFeatures;
...
**/
- (void)xmppBoshStream:(XMPPBoshStream *)sender didRegisterModule:(id)module;
- (void)xmppBoshStream:(XMPPBoshStream *)sender willUnregisterModule:(id)module;
